...
//       try {
//         const response = await axios.get(`${config.apiBaseUrl}/patch-result/${jsonId}`);
...
//   const countStatuses = resultData?.processDetails?.length
//   ? resultData.processDetails.reduce((counters, process) => {
